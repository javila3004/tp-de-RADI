window.addEventListener('load', function() {
  const markdown = `# Investigación sobre RAID y sus Diferentes Niveles
...
- **Importancia:**  
  ...
  if (window.markmap?.transform && window.markmap?.Markmap) {
    ...
    // Crea el markmap
    const mm = window.markmap.Markmap.create('#mindmap', null, root);
    
    // Toolbar (opcional pero recomendado)
